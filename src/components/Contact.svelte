...
<div class="container-boxed no-select relative isolate px-6 pt-1 pb-4 lg:px-8">
    ...
    {/if}
    <div class="flex flex-col md:flex-row gap-x-10 justify-between">
        <div class="flex flex-col gap-y-8 w-full md:w-8/12 lg:w-8/12">
            <div class="contact-content text-second text-justify">
                <p>
                    I'm available for full-time roles, freelance gigs, and
                    hourly consulting services. Please don't hesitate to contact
                    me if you have any projects, requests, or questions!
                </p>
                {#if full}
                    <p>
        ...
        <div class="contact-card-wrap w-full mt-8 md:mt-0 md:w-3/12">
            <div class="contact-card">
                <div class="contact-socials">
                    <ul class="pt-2">
                        <li
                            on:mouseenter={handleShowEmail}
                            on:mouseleave={handleHideEmail}
                        >
                            <a
                                href="#"
                                class="contact-link magic-hover block p-1 mb-2"
                                on:click={handleMailSend}
                            >
                                <MailIcon />
                        ...
                        <li>
                            <a
                                href="https://www.linkedin.com/in/mogamil/"
                                class="contact-link magic-hover block p-1 mb-2"
                                target="_blank"
                            >
                                <LinkedinIcon />
